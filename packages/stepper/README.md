...
```json
"usingComponents": {
  "fbm-stepper": "fbmui-weapp/stepper/index"
}
```
...
```html
<fbm-stepper value="{{ 1 }}" bind:change="onChange" />
```
...
```html
<fbm-stepper value="{{ 5 }}" min="5" max="8" />
```
...
```html
<fbm-stepper value="{{ 1 }}" long-press="{{ false }}" />
```
...
```html
<fbm-stepper value="{{ 1 }}" step="0.2" decimal-length="{{ 1 }}" />
```
...
```html
<fbm-stepper value="{{ value }}" async-change bind:change="onChange" />
```
...
```html
<fbm-stepper value="{{ 1 }}" input-width="40px" button-size="32px" />
```
