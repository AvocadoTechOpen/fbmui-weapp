    ...
    methods: {
        ...
        setAnchorsRect: function () {
            ...
            return Promise.all(this.children.map(function (anchor) {
                return (0, utils_1.getRect)(anchor, '.fbm-index-anchor-wrapper').then(function (rect) {
        ...
        setListRect: function () {
            var _this = this;
            return (0, utils_1.getRect)(this, '.fbm-index-bar').then(function (rect) {
        ...
        setSiderbarRect: function () {
            var _this = this;
            return (0, utils_1.getRect)(this, '.fbm-index-bar__sidebar').then(function (res) {
        ...
        getAnchorRect: function (anchor) {
            return (0, utils_1.getRect)(anchor, '.fbm-index-anchor-wrapper').then(function (rect) { return ({
                height: rect.height,
                top: rect.top,
            }); });
        },
