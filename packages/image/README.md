...
```json
"usingComponents": {
  "fbm-image": "fbmui-weapp/image/index"
}
```
...
```html
<fbm-image width="100" height="100" src="https://img.yzcdn.cn/vant/cat.jpeg" />
```
...
```html
<fbm-image use-loading-slot>
  <fbm-loading slot="loading" type="spinner" size="20" vertical />
</fbm-image>
```
