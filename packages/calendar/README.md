...
```json
"usingComponents": {
  "fbm-calendar": "fbmui-weapp/calendar/index"
}
```
...
```html
<fbm-cell title="选择单个日期" value="{{ date }}" bind:click="onDisplay" />
<fbm-calendar show="{{ show }}" bind:close="onClose" bind:confirm="onConfirm" />
```
...
```html
<fbm-cell title="选择多个日期" value="{{ text }}" bind:click="onDisplay" />
<fbm-calendar
  show="{{ show }}"
  type="multiple"
  bind:close="onClose"
...
```html
<fbm-cell title="选择日期区间" value="{{ date }}" bind:click="onDisplay" />
<fbm-calendar
  show="{{ show }}"
  type="range"
  bind:close="onClose"
...
```html
<fbm-calendar show="{{ show }}" show-confirm="{{ false }}" />
```
...
```html
<fbm-calendar show="{{ show }}" color="#07c160" />
```
...
```html
<fbm-calendar show="{{ show }}" type="range" formatter="{{ formatter }}" />
```
...
```html
<fbm-calendar show="{{ show }}" round="false" position="right" />
```
...
```html
<fbm-calendar type="range" max-range="{{ 3 }}" />
```
...
```html
<fbm-calendar first-day-of-week="{{ 1 }}" />
```
