...
```json
"usingComponents": {
  "fbm-popup": "fbmui-weapp/popup/index"
}
```
...
```html
<fbm-cell title="展示弹出层" is-link bind:click="showPopup" />

<fbm-popup show="{{ show }}" bind:close="onClose">内容</fbm-popup>
```
...
<fbm-popup show="{{ show }}" catch:touchstart />
```
