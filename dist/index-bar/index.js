...
VantComponent({
    ...
    methods: {
        ...
        setAnchorsRect() {
            return Promise.all(this.children.map((anchor) => getRect(anchor, '.fbm-index-anchor-wrapper').then((rect) => {
        ...
        setListRect() {
            return getRect(this, '.fbm-index-bar').then((rect) => {
                if (!isDef(rect)) {
                    return;
                }
                Object.assign(this, {
        ...
        setSiderbarRect() {
            return getRect(this, '.fbm-index-bar__sidebar').then((res) => {
                if (!isDef(res)) {
                    return;
                }
                this.sidebar = {
        ...
        getAnchorRect(anchor) {
            return getRect(anchor, '.fbm-index-anchor-wrapper').then((rect) => ({
                height: rect.height,
                top: rect.top,
            }));
        },
