...
(0, component_1.VantComponent)({
    ...
    methods: {
        getContext () {
            const _this = this;
            const _a = this.data; const {type} = _a; const {size} = _a;
            if (type === '' || !(0, version_1.canIUseCanvas2d)()) {
                const ctx = wx.createCanvasContext('fbm-circle', this);
        ...
        setHoverColor () {
            const _this = this;
            const _a = this.data; const {color} = _a; const {size} = _a;
        ...
        presetCanvas (context, strokeStyle, beginAngle, endAngle, fill) {
            const _a = this.data; const {strokeWidth} = _a; const {lineCap} = _a; const {clockwise} = _a; const {size} = _a;
        ...
        renderLayerCircle (context) {
            const _a = this.data; const {layerColor} = _a; const {fill} = _a;
        ...
        reRender () {
            ...
            const _a = this.data; const {value} = _a; const {speed} = _a;
