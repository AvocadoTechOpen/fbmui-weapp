    ...
    methods: {
        init () {
            ...
            (0, utils_1.requestAnimationFrame)(() => {
                Promise.all([
                    (0, utils_1.getRect)(_this, '.fbm-notice-bar__content'),
                    (0, utils_1.getRect)(_this, '.fbm-notice-bar__wrap'),
                ]).then((rects) => {
                    const contentRect = rects[0]; const wrapRect = rects[1];
                    const _a = _this.data; const {speed} = _a; const {scrollable} = _a; const {delay} = _a;
                    if (contentRect == null ||
                        wrapRect == null ||
                        !contentRect.width ||
                        !wrapRect.width ||
