...
```json
"usingComponents": {
  "fbm-sticky": "fbmui-weapp/sticky/index"
}
```
...
```html
<fbm-sticky>
  <fbm-button type="primary">基础用法</fbm-button>
</fbm-sticky>
```
...
<fbm-sticky offset-top="{{ 50 }}">
  <fbm-button type="info">吸顶距离</fbm-button>
</fbm-sticky>
```
...
<view id="container" style="height: 150px;">
  <fbm-sticky container="{{ container }}">
    <fbm-button type="warning">指定容器</fbm-button>
  </fbm-sticky>
</view>
```
...
>
  <view style="height: 400px; padding-top: 50px;">
    <fbm-sticky scroll-top="{{ scrollTop }}" offset-top="{{ offsetTop }}">
      <fbm-button type="warning">嵌套在 scroll-view 内</fbm-button>
    </fbm-sticky>
  </view>
</scroll-view>
```
