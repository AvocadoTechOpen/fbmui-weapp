...
```json
"usingComponents": {
  "fbm-transition": "fbmui-weapp/transition/index"
}
```
...
```html
<fbm-transition show="{{ show }}" custom-class="block">内容</fbm-transition>
```
...
```css
.fbm-enter-active-class,
.fbm-leave-active-class {
