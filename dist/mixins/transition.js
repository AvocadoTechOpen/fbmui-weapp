...
const getClassNames = (name) => ({
    ...
    leave: `fbm-${name}-leave fbm-${name}-leave-active leave-class leave-active-class`,
    'leave-to': `fbm-${name}-leave-to fbm-${name}-leave-active leave-to-class leave-active-class`,
});
