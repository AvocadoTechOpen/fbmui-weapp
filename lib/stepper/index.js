...
(0, component_1.VantComponent)({
    ...
    methods: {
        observeValue () {
            const _a = this.data; const {value} = _a; const {currentValue} = _a;
        ...
        isDisabled (type) {
            const _a = this.data; const {disabled} = _a; const {disablePlus} = _a; const {disableMinus} = _a; const {currentValue} = _a; const {max} = _a; const {min} = _a;
            if (type === 'plus') {
